...
# Create test_integration.py and requirements.txt
...
with open("deconflict/tests/test_integration.py", "w") as f:
...
with open("deconflict/requirements.txt", "w") as f:
    f.write(requirements_content)

print("✓ Created test_integration.py and requirements.txt")
